...
#     date_ls = get_every_date(start_date, end_date)
...
#     for tmp_date, tmp_dc in dict_wechat.iteritems():
#         if tmp_date == date:
#             continue
#         for tmp_opp, tmp_dc_ls in tmp_dc.iteritems():
...
#         for tmp_opp, tmp_dc_ls in dict_wechat[date].iteritems():
#
...
#                     for tmp_word, tmp_tf in dict_word_tf.iteritems():
...
#                 for tmp_word, tmp_tf in statistic_tf_dict.iteritems():
