...
def evaluate_model(model_saved_path, valid_tf_record_path, start_date, end_date):
    assert os.path.isdir(model_saved_path) and os.path.isdir(valid_tf_record_path)
